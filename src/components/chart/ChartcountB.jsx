...
function make(data_raw,new_var){
    if(data_raw !=null ){
        for(let i=0;i<10;i++){ 
            new_var[0].data.push(data_raw[i].sum_car_down);
            new_var[1].data.push(data_raw[i].sum_truck_s_down);
            new_var[2].data.push(data_raw[i].sum_truck_m_down);
            new_var[3].data.push(data_raw[i].sum_truck_l_down);
