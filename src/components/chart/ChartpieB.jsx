...
function make2(data,new_var){
    if(data !=null ){
        for(let i=0;i<1;i++){
            new_var.push(data.presentase_car_down, data.presentase_truck_s_down,data.presentase_truck_m_down,data.presentase_truck_l_down,data.presentase_truck_xl_down,data.presentase_bus_s_down,data.presentase_bus_l_down);
        }
    }
} 
