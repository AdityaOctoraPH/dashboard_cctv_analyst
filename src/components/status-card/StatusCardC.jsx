    ...
    if(data !=null ){
        // for(let i=0;i<1;i++){
            new_var.push({
                ...
                count: data[0].sum_truck_m_up,
                title: "Medium Truck"
            },{
                count: data[0].sum_truck_l_up,
                title: "Large Truck"
            },{
                count: data[0].sum_truck_xl_up,
                title: "XL Truck"
            },{
                count: data[0].sum_bus_s_up,
                title: "Small Bus"
            },{
                count: data[0].sum_bus_l_up,
                title: "Big Bus"
...
const StatusCardC = props => {
    ...
    const getData = async()=> {
        axios.all([request1]).then(axios.spread((...res) => {
